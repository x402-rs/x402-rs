...
impl KnownNetworkAptos<ChainId> for ChainId {
    ...
    fn aptos_testnet() -> ChainId {
        aptos::AptosChainReference::aptos_testnet().into()
    }
}
...
impl KnownNetworkAptos<aptos::AptosTokenDeployment> for USDC {
    fn aptos() -> aptos::AptosTokenDeployment {
        ...
        let address: aptos::Address =
            "0xbae207659db88bea0cbead6da0ed00aac12edcdda169e591cd41c94180b46f3b"
                .parse()
                .expect("Invalid USDC address");
        aptos::AptosTokenDeployment::new(aptos::AptosChainReference::aptos(), address, 6)
    }

    fn aptos_testnet() -> aptos::AptosTokenDeployment {
        // USDC on Aptos testnet (this is a placeholder address, actual testnet USDC may differ)
        let address: aptos::Address =
            "0xbae207659db88bea0cbead6da0ed00aac12edcdda169e591cd41c94180b46f3b"
                .parse()
                .expect("Invalid USDC address");
        aptos::AptosTokenDeployment::new(aptos::AptosChainReference::aptos_testnet(), address, 6)
    }
}
